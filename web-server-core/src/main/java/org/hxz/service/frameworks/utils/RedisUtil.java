...
/**
 * Created by hxz on 2021/12/1 17:25.
 */
...
public final class RedisUtil {
    ...
    static{
         redisTemplate = AppContext.getBean(RedisTemplate.class,"myRedisTemplate");
    }
     ...
     * @return 成功个数
     */
    public static long sSetWithExpire(String key, long time, Object... values) {
        try {
     ...
     * @return
     */
    public static boolean lSets(String key, List<Object> value) {
        try {
     ...
     * @return
     */
    public static boolean lSets(String key, List<Object> value, long time) {
        try {
            redisTemplate.opsForList().rightPushAll(key, value);
            if (time > 0) {
                expire(key, time);
